module AtlasSmsApi
  module Configuration
    ...
    VALID_OPTIONS_KEYS      = [:access_key, :secret_key, :format].freeze
    VALID_CONFIG_KEYS       = VALID_CONNECTION_KEYS + VALID_OPTIONS_KEYS

    DEFAULT_ENDPOINT        = "https://devsms.atlas.money/v1/".freeze
    DEFAULT_REQUEST_METHOD = :get
    DEFAULT_USER_AGENT      = "AtlasSmsApi API Ruby Gem #{AtlasSmsApi::VERSION}".freeze
